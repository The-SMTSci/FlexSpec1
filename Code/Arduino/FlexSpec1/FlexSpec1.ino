...
//int UVBoostLED;    // UV LED start off
...
//  ===============================================================================================
int dataArray1[8] = { B00000001, B00000011, B00000010, B00000110, B00000100, B00001100, B00001000, B00001001 };  //motor 1 CW
int dataArray2[8] = { B00001001, B00001000, B00001100, B00000100, B00000110, B00000010, B00000011, B00000001 };  //motor 1 CCW

// Patterns for grating motor drive, 8 drive patterns,
//  ===============================================================================================
int dataArray4[8] = { B00010000, B00110000, B00100000, B01100000, B01000000, B11000000, B10000000, B10010000 };  //motor 2 grating CW
int dataArray3[8] = { B10010000, B10000000, B11000000, B01000000, B01100000, B00100000, B00110000, B00010000 };  //motor 2 grating CCW
