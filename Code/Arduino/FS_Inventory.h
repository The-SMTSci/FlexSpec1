#ifndef __FSINVENTORY__h__
#define __FSINVENTORY__h__#ifdef __REGRESSION__
   #include <iostream>
#endif
...
/******************************************************************************
* FSInventory
* Collaborators:       Postmaster
* Responcibilities
*    Postmaster:
*      Maintain and serve up list of 'this' pointers to Postmaster
*      based on the "name" of the widget.
*      Each widget will have an InventoryEntry
*
******************************************************************************/
