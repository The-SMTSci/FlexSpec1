...
class ConsoleBase(object):
    ...
    def __init__(self, miniterm):                     # ConsoleBase::
    ...
    def setup(self):                                  # ConsoleBase::
        """Set console to read single characters, no echo"""

    def cleanup(self):                                # ConsoleBase::
        """Restore default console settings"""

    def getkey(self):                                 # ConsoleBase::
        """Read a single key from the console"""
        return None

    def write_bytes(self, byte_string):               # ConsoleBase::
        """Write bytes (already encoded)"""
        self.byte_output.write(byte_string)
        self.byte_output.flush()

    def write(self, text):                            # ConsoleBase::
        """Write string"""
        self.output.write(text)
        self.output.flush()

    def cancel(self):                                 # ConsoleBase::
    ...
    def __enter__(self):                              # ConsoleBase::
        self.cleanup()
        return self

    def __exit__(self, *args, **kwargs):              # ConsoleBase::
        self.setup()
